    ...
    */
    RGraph.background.Draw = function (obj)
    {
        ...
        if (typeof(obj.Get('chart.title.xaxis')) == 'string' && obj.Get('chart.title.xaxis').length) {
            ...
            context.beginPath();
            RGraph.Text(context, font, size, obj.canvas.width / 2, obj.canvas.height - (gutterBottom * obj.Get('chart.title.xaxis.pos')), obj.Get('chart.title.xaxis'), 'center', 'center', false, false, false, bold);
            context.fill();
        }
