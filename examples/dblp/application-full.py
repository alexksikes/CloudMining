...
cl = FSphinxClient.FromConfig('config-full/sphinx_client.py')

# create similarity search client
sim_cl = SimClient.FromConfig('config-full/simsearch_client.py')

# create a new CloudMining web application
app = CloudMiningApp(autoreload=False)
